...
$(document).ready(function()
{
	...
	// when location dropdown changes
	...
	table_support.query_params = function()
	{
		return {
			...
			end_date: end_date,
			location_id: $("#location_filter").val() || 'all',
			filters: $("#filters").val() || [""]
		}
	};
	...
	table_support.init({
		...
		onLoadSuccess: function(response) {
			// Always update payment summary when data loads
...
<div id="toolbar">
	<div class="pull-left form-inline" role="toolbar">
		...
		<?php if (!empty($stock_locations)): ?>
			<?php echo form_dropdown('location_filter', $stock_locations, 'all', array('id'=>'location_filter', 'class'=>'selectpicker show-menu-arrow', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
		<?php endif; ?>
